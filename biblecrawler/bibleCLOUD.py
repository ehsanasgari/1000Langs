...
if __name__ == '__main__':
    if requests.get("http://bible.cloud/robot.txt").status_code ==404:
        print ("No robot.txt found. Let's continue..")
    else:
        if query_yes_no("There is a robot.txt file at http://bible.cloud/robot.txt. Do you want to check manually your eligibility first?"):
            exit()
        else:
